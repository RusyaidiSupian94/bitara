                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="home-tab-pane" aria-selected="true">Main</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link " id="order-tab" data-bs-toggle="tab"
                                    data-bs-target="#order-tab-pane" type="button" role="tab"
                                    aria-controls="order-tab-pane" aria-selected="true">Ordering</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                        ...
                                        @foreach ($orders as $order)
                                            <tr>
                                                ...
                                                @elseif ($order->order_status == 'P')
                                                    <td><span
                                                            class="badge rounded-pill bg-label-warning me-1">Preparing</span>
                                                    </td>
                                                @elseif ($order->order_status == 'D')
                                                    <td><span
                                                            class="badge rounded-pill bg-label-info me-1">Delivering</span>
                                                    </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <a target="_blank"
                                                            href="{{ route('complete-order-detail', ['id' => $order->id,'page' => 'r']) }}">
